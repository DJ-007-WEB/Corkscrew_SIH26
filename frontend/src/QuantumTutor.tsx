      ...
      {isOpen && (
        ...
        >
            ...
            <div className="px-3 py-2 border-t border-[var(--bp-border)] bg-[var(--bp-panel-raised)]/40 flex flex-wrap gap-1.5 shrink-0">
              ...
              <button type="button" disabled={loading} onClick={() => void send("Is this a Bell state? Explain the entanglement in this circuit.", "bell")} className="text-[10px] font-mono border border-[var(--bp-border)] rounded px-2 py-1 text-[var(--bp-text-dim)] hover:border-[var(--bp-cyan)] hover:text-[var(--bp-cyan)] transition-colors disabled:opacity-50 cursor-pointer">Bell check</button>
              <button type="button" disabled={loading} onClick={() => void send("Does this circuit look like Deutsch-Jozsa? Is the oracle constant or balanced?", "deutsch")} className="text-[10px] font-mono border border-[var(--bp-border)] rounded px-2 py-1 text-[var(--bp-text-dim)] hover:border-[var(--bp-cyan)] hover:text-[var(--bp-cyan)] transition-colors disabled:opacity-50 cursor-pointer">DJ check</button>
              <button type="button" disabled={loading} onClick={() => void send("Did Grover amplification succeed here? Which state was marked?", "grover")} className="text-[10px] font-mono border border-[var(--bp-border)] rounded px-2 py-1 text-[var(--bp-text-dim)] hover:border-[var(--bp-cyan)] hover:text-[var(--bp-cyan)] transition-colors disabled:opacity-50 cursor-pointer">Grover check</button>
              <button type="button" disabled={loading} onClick={() => void send("Walk through the teleportation steps in this circuit.", "teleport")} className="text-[10px] font-mono border border-[var(--bp-border)] rounded px-2 py-1 text-[var(--bp-text-dim)] hover:border-[var(--bp-cyan)] hover:text-[var(--bp-cyan)] transition-colors disabled:opacity-50 cursor-pointer">Teleport check</button>
            </div>
